...
The Testing branch is responsible for holding the current development code. Very little or no testing has been done on the code included in it and as such it should not be used in a competitive environment. If the code located in the Testing branch has been confirmed to be working in a valid test environment, a Pull Request should be submitted to update the master branch to the current Testing state. Edward Jones (frc3260@gmail.com) should be the only one approving Pull Requests and merges.
