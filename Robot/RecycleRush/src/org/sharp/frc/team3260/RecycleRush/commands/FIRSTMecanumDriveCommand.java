...
public class FIRSTMecanumDriveCommand extends Command
{
    ...
    protected void execute()
    {
        ...
        {
            DriveTrain.getInstance().stockMecnaumDrive(strafe, forward, rotation, 0);
        }
        else
        {
            DriveTrain.getInstance().stockMecnaumDrive(strafe, forward, rotation, DriveTrain.getInstance().getIMU().getYaw());
